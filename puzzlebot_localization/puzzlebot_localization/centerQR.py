...
class ArucoPoseNode(Node):
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(
            CompressedImage, '/video_source/compressed', self.image_callback,  qos.qos_profile_sensor_data)
        ...
        # ── Timers ───────────────────────────────────────────────────────
        self.timer_main = self.create_timer(1 / 15,  self.process_and_publish)
    ...
    def _mcl_pose_callback(self, msg: PoseWithCovarianceStamped):
        ...
        self.kf.R = old_R   # restaurar R original para ArUco
    ...
    def _publish_pose(self):
        ...
        msg_c.pose.pose.position.x    = self.kf_x - self.MAP_OFFSET_X
        msg_c.pose.pose.position.y    = self.kf_y - self.MAP_OFFSET_Y
