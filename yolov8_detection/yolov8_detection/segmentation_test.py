...
class YoloV8Detection(Node):
    ...
    def _load_yolo_model(self):
        ...
        try:
            package_share_dir = get_package_share_directory('yolov8_detection')
            ...
            for r in results:
                ...
                if boxes is not None:
                    ...
                    for i, box in enumerate(boxes):
                        ...
                        inference_result.left = int(coords[0])
                        inference_result.top = int(coords[1])
                        inference_result.right = int(coords[2])
                        inference_result.bottom = int(coords[3])
                        ...
                        if masks is not None:
                            ...
                            colored_mask = (mask > 0.5).astype('uint8') * 255
